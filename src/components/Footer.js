      ...
      <footer className="footer">
        <div className="container">
          ...
          <div className="footer__copyright">
            <small><a href="/versions/">Version 7.0</a>, built using <a href="https://www.gatsbyjs.org/">Gatsby</a> and hosted on <a href="https://www.netlify.com/">Netlify</a>. You can see the source code on <a href={config.repository}>Github</a>.</small>
          </div>
        </div>
      </footer>
    );
